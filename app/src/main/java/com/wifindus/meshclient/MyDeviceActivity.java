...
public class MyDeviceActivity extends ActionBarActivity {
    ...
    //==============================================================================================
    // Listen for click on Force Mesh WiFi
    //==============================================================================================
    public void forceMeshWiFi(View v)
    {
        ImageView view = (ImageView)findViewById(R.id.forceMesh);
        if(forceMeshState == 0)
        {
            view.setImageResource(R.drawable.mesh_blue);
            forceMeshState = 1;
        }
        else
        {
            view.setImageResource(R.drawable.mesh_gray);
            forceMeshState = 0;
        }
    }
    //==============================================================================================
    // END :: Listen for click on Force Mesh WiFi
    //==============================================================================================
